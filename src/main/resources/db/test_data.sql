...
VALUES
    ...
    (gen_random_uuid(), 'aaaaaaaa-3333-3333-3333-000000000001', '80대',  50,  10, 40, 20.0, 55000)
...
VALUES
    ...
    (gen_random_uuid(), 'aaaaaaaa-3333-3333-3333-000000000002', '80대',  10,   3,  7, 30.0, 48000)
ON CONFLICT DO NOTHING;
...
VALUES
    ...
    ('aaaaaaaa-4444-4444-4444-000000000001', '80대', 0.72, 0.35, 42, 84.0,100.0, 9.1, 'Timeout', 9, 4, 2, '80대 가장 심각'),
